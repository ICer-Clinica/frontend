...
interface ITherapistsListing {
    entity: 'clinicAdm' | 'coordinator' | 'admnistrativeSecretary'
}

export default function TherapistsListing({entity}: ITherapistsListing) {
